...
$cheche = $_POST['yess']; // сохраняем в переменную данные полученные из поля c адресом электронной почты
...
$msg .= "Пользователь согласился с обработкой его персональных данных: ".$cheche."\r\n";
